import { createConnection, deploy, aliceKeypair, transaction, dry_run_instansiate, debug_buffer } from "../index";
import expect from 'expect';
import { ContractPromise, CodeRx, CodePromise } from "@polkadot/api-contract";
...
describe('Deploy debug_buffer.sol and test the debug buffer', () => {
 ...
 let res20 = await dry_run_instansiate("Printer.contract",conn);
  console.log (res20.result)
