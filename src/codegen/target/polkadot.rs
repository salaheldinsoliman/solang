...
pub(super) struct PolkadotTarget;
...
impl TargetCodegen for PolkadotTarget {
    ...
    fn constructor_success(&self, vartab: &mut Vartable) -> Option<usize> {
        Some(vartab.temp_name("success", &Type::Uint(32)))
    }
    ...
    fn constructor_result(
        ...
        let success = success.expect("polkadot constructor checks require a success variable");

        codegen_polkadot::RetCodeCheckBuilder::default()
            .loc(loc)
    ...
    fn print(&self) -> PrintBehavior {
        PrintBehavior::PrefixAndDelimiter
    }
    ...
    fn external_call_success(&self, vartab: &mut Vartable) -> Option<usize> {
        Some(vartab.temp_name("success", &Type::Uint(32)))
    }
    ...
    fn external_call_status(
        ...
        let success = success.expect("polkadot external call checks require a success variable");
        codegen_polkadot::RetCodeCheckBuilder::default()
            .loc(loc)
            .msg(msg)
            .success_var(success)
    ...
    fn payable_transfer(
        ...
        codegen_polkadot::check_transfer_ret(loc, success, cfg, ns, opt, vartab, true);
